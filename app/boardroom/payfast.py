        ...
        <div class="max-w-2xl mx-auto p-8">
            ...
            <div class="grid grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-[#1B2838] border-2 border-[#028090] rounded-lg p-6">
                    ...
                    <a href="https://www.paypal.com/ncp/payment/L2D6BWZGY9KVW"
                       target="_blank"
                       class="block mt-2 bg-[#0070BA] text-white text-center py-3 rounded-lg font-bold hover:bg-[#005C99] transition-colors">
                        Pay with PayPal (USD)
                    </a>
                    <p class="text-[10px] text-slate-500 mt-2 text-center">\.99/month — choose your preferred payment method — $1.99/month
                    </a>
                </div>
            </div>
