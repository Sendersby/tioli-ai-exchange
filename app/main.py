...
@app.get("/api/v1/sandbox/monitoring/report/{period}", tags=["Sandbox"])
...
@app.get("/api/v1/sandbox/kyc/tier/{entity_id}", tags=["Sandbox"])
async def api_sandbox_kyc_tier(entity_id: str, db: AsyncSession = Depends(get_db)):
    from app.arch.kyc_enhanced import get_kyc_status
    return await get_kyc_status(db, entity_id)

# A-4 continued: Credit score lookup
@app.get("/api/v1/sandbox/credit/score/{entity_id}", tags=["Sandbox"])
...
@app.get("/api/v1/sandbox/lending/terms/{loan_id}", tags=["Sandbox"])
...
@app.post("/api/v1/sandbox/lending/seize-collateral/{loan_id}", tags=["Sandbox"])
...
@app.post("/api/v1/sandbox/lending/restructure/{loan_id}", tags=["Sandbox"])
...
@app.get("/api/v1/sandbox/compliance/reports", tags=["Sandbox"])
...
@app.delete("/api/v1/sandbox/vault/remove/{vault_id}/{key}", tags=["Sandbox"])
...
@app.get("/api/v1/sandbox/vault/list/{vault_id}", tags=["Sandbox"])
...
@app.get("/api/v1/sandbox/vault/usage/{vault_id}", tags=["Sandbox"])
...
@app.get("/api/v1/sandbox/guilds", tags=["Sandbox"])
...
@app.get("/api/v1/sandbox/futures", tags=["Sandbox"])
...
# B-7: Benchmarking
@app.post("/api/v1/sandbox/benchmark/report", tags=["Sandbox"])
...
@app.get("/api/v1/sandbox/badge/{agent_id}", tags=["Sandbox"])
...
@app.get("/api/v1/sandbox/notifications/templates", tags=["Sandbox"])
...
@app.post("/api/v1/sandbox/withdrawal/{withdrawal_id}/approve", tags=["Sandbox"])
...
@app.post("/api/v1/sandbox/withdrawal/{withdrawal_id}/reject", tags=["Sandbox"])
...
@app.get("/api/v1/sandbox/withdrawal/queue", tags=["Sandbox"])
...
@app.post("/api/v1/sandbox/self-dev/{proposal_id}/deploy", tags=["Sandbox"])
...
@app.post("/api/v1/sandbox/self-dev/{proposal_id}/rollback", tags=["Sandbox"])
...
@app.get("/api/v1/sandbox/self-dev/proposals", tags=["Sandbox"])
...
@app.post("/api/v1/sandbox/self-dev/propose-structural", tags=["Sandbox"])
...
@app.post("/api/v1/sandbox/self-dev/{proposal_id}/approve", tags=["Sandbox"])
...
@app.get("/api/v1/sandbox/self-dev/{proposal_id}/status", tags=["Sandbox"])
...
@app.post("/api/v1/sandbox/onboarding/register", tags=["Sandbox"])
...
@app.post("/api/v1/sandbox/onboarding/{entity_id}/verify", tags=["Sandbox"])
...
@app.post("/api/v1/sandbox/onboarding/{operator_id}/register-agent", tags=["Sandbox"])
...
@app.get("/api/v1/sandbox/onboarding/list", tags=["Sandbox"])
